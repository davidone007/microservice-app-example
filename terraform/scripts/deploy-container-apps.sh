...
echo "🚀 Despliegue automatizado: Terraform Container Apps"
...
# Module selector (default to container-apps)
TF_MODULE="${TF_MODULE:-container-apps}"
...
terraform plan -out=container-apps.plan -input=false $VAR_FILE_ARG
